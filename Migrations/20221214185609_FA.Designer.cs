...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActorFilm", b =>
                {
                    ...
                    b.ToTable("FA", (string)null);
                });

            modelBuilder.Entity("CinemaDB.Models.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Actors__3214EC27FF254FBK");
            ...
            modelBuilder.Entity("CinemaDB.Models.Film", b =>
                {
                    ...
                    b.HasAlternateKey("FName")
                        .HasName("AlternateKey_FName");
            ...
            modelBuilder.Entity("CinemaDB.Models.MiniCinema", b =>
                {
                    b.HasBaseType("CinemaDB.Models.Cinema");

                    b.Property<int?>("Kids")
                        .HasColumnType("int");

                    b.ToTable("Minicinemas", (string)null);
                });

            modelBuilder.Entity("ActorFilm", b =>
                {
                    b.HasOne("CinemaDB.Models.Actor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaDB.Models.MiniCinema", b =>
                {
                    b.HasOne("CinemaDB.Models.Cinema", null)
                        .WithOne()
                        .HasForeignKey("CinemaDB.Models.MiniCinema", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
